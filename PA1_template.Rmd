...
```{r}
ActivityData<- read.csv("C:/Users/204027408/Desktop/R Programs/Examples/RRAssigment1/RepData_Assignment1/activity.csv", header=TRUE, colClasses= c("numeric", "Date", "numeric"))
